...
fighter1 = Fighter(200, 310, False, WARRIOR_DATA, warrior_sheet, WARRIOR_ANIMATION_STEPS)
fighter2 = Fighter(700, 310, True, WIZARD_DATA, wizard_sheet, WIZARD_ANIMATION_STEPS)
...
while gameLoop:
    ...
    # fighter2.move(WIDTH, HEIGHT, screen, fighter1)
